...
public class ProjectActivity  extends AppCompatActivity implements PhaseAdapter.OnAddPhaseListener,
        PhaseAdapter.OnAddTaskListener, PhaseAdapter.OnTaskActionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();
        phaseAdapter = new PhaseAdapter(phaseList, this, this, this);
    ...
    public void onAddPhase() {
        ...
        phaseList.add(new Phase("Ds" + (phaseList.size()+1), t));
